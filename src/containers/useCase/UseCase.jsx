      ...
      <div className="usecase-content">
        <div className="usecase-content_1">
          ...
          <div className="usecase-content_1-body">
            ...
            <p>
              Land-use classification, Digitisation of land titles, Crop acreage
              estimation, Plan import and export of fish products
            </p>
          </div>
        </div>
        <div className="usecase-content_2">
          ...
          <div className="usecase-content_1-body">
            ...
            <p>
              Utilize alternative data for assessing pond type, pond health, and
              performance to evaluate credit risks in aquaculture
            </p>
          </div>
        </div>
        <div className="usecase-content_3">
          ...
          <div className="usecase-content_1-body">
            ...
            <p>
              Get supply-demand insights, Remotely monitor pond health, stress,
              water quality and yield, eliminating frequent on-site visits
            </p>
          </div>
        </div>
        <div className="usecase-content_4">
          ...
          <div className="usecase-content_1-body">
            <h4>Insurance</h4>
            <p>
              Map and appraise extent of damage on ponds (due to rain, floods,
              droughts, etc.), Aquaculture pond insurance
            </p>
          </div>
        </div>
      </div>
